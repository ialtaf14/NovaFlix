...
export default function ImageUploadModal({ isOpen, onClose, onUpload, type }) {
  ...
  const drawCanvas = () => {
    ...
    img.src = imageSrc;
    img.onload = () => {
      const targetWidth = type === 'cover' ? 1200 : 400;
      const targetHeight = type === 'cover' ? 400 : 400;
  ...
  return (
    <div className="upload-modal-overlay">
      <div className="upload-modal-content">
        <h2>{type === 'cover' ? 'Change Cover Photo' : 'Change Profile Photo'}</h2>
              ...
              {isVideoFile ? (
                ...
                <canvas 
                  ...
                  style={{ 
                    ...
                    height: 'auto', 
                    maxHeight: '400px', 
                    borderRadius: type === 'cover' ? '8px' : '50%',
                    objectFit: 'cover',
